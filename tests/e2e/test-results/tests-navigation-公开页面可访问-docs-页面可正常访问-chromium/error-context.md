...
- Name: tests/navigation.spec.ts >> 公开页面可访问 >> /docs 页面可正常访问
- Location: tests/navigation.spec.ts:25:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/docs
Call log:
  - navigating to "http://localhost:3000/docs", waiting until "load"
