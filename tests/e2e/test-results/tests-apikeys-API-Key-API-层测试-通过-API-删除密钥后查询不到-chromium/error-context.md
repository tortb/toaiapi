...
- Name: tests/apikeys.spec.ts >> API Key API 层测试 >> 通过 API 删除密钥后查询不到
- Location: tests/apikeys.spec.ts:333:7
...
Received: {"createdAt": "2026-06-07T20:09:13.699Z", "expiresAt": null, "group": null, "groupId": null, "groupName": null, "id": "cmq47tlgi0009ju4rusvjz4tt", "ipWhitelist": [], "isActive": true, "keyPrefix": "sk-toai-OqSRmPb-", "keySuffix": "mPb-", "lastUsedAt": null, "modelLimit": [], "name": "e2e-key-1780862953204-8l3v", "rateLimit": null, "rpmLimit": null, "status": "ACTIVE", "tokenLimit": null, "totalRequests": 0, "tpmLimit": null, "unlimitedQuota": false, "usage30d": 0, "usageToday": 0}
```
