...
export function selectChannel(
  channels: Channel[],
  strategy: SelectionStrategy = 'priority_weighted',
): Channel | null {
 ...
 */
function weightedRoundRobin(channels: Channel[]): Channel {
 ...
 */
function lowestLatency(channels: Channel[]): Channel {
 ...
 */
function priorityWeighted(channels: Channel[]): Channel {
