...
export default async function StatusPage() {
    ...
    return (<SiteShell>
      <section className="max-w-[900px] mx-auto px-6 py-12">
        ...
        {status.length === 0 ? (<div className="text-gray-500">无法获取状态数据，请稍后重试。</div>) : (<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {status.map((s) => (<div key={s.name} className="bg-white border border-gray-100 rounded-lg p-4 flex items-center justify-between">
                <div>
