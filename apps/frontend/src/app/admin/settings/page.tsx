...
const FIELDS: Record<string, FieldDef[]> = {
  basic: [
    ...
    { key: "icp_number_show", label: "显示ICP备案", type: "boolean", tip: "在页脚显示ICP备案号" },
  ...
  register: [
    ...
    { key: "whitelist_emails", label: "白名单邮箱", type: "textarea", placeholder: "每行一个邮箱或用逗号分隔", tip: "开启白名单后，仅这些邮箱可以注册" },
