...
import { getRoles, getRole, getPermissions, } from "@/lib/admin-api";
    ...
    return (<div className="min-h-screen bg-[#F5F7FA] text-gray-900 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          {/* 错误提示 */}
          {error && (<div className="mb-4 p-4 bg-red-50 border border-red-100 rounded-lg">
          ...
          {isLoading ? (<div className="p-8 text-center">
                ...
                <div className="bg-white rounded-lg border border-gray-100">
                  ...
                  <ul>
                    {roles.map((role) => (<li key={role.id}>
                        <button onClick={() => loadRoleDetail(role.id)} className={`w-full text-left px-4 py-3 border-b border-gray-50 hover:bg-gray-50 transition ${selectedRole?.id === role.id ? "bg-primary-50" : ""}`}>
              ...
              <div className="col-span-8">
                {selectedRole ? (<div className="bg-white rounded-lg border border-gray-100">
                    <div className="px-6 py-4 border-b border-gray-100">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {selectedRole.isSystem && (<span className="px-2 py-1 text-xs bg-primary-50 text-primary rounded">
                              系统角色
                            </span>)}
                        </div>
                      </div>
                    ...
                    <div className="p-6">
                      ...
                      {selectedRole.permissions.length === 0 ? (<p className="text-sm text-gray-500">该角色暂无权限</p>) : (<div className="space-y-6">
                        ...
                        return (<div key={resource}>
                                ...
                                return (<span key={perm.code} className={`px-2 py-1 text-xs rounded ${hasPerm
                  ...
                  </div>) : (<div className="bg-white rounded-lg border border-gray-100 p-8 text-center">
