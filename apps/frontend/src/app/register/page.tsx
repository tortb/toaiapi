...
import { notifyError, notifySuccess } from "@/lib/feedback/events";
...
export default function RegisterPage() {
  ...
  async function handleSendCode(captchaVerifyParam?: string) {
    ...
    try {
      ...
      notifySuccess("验证码已发送，请查收邮箱", "发送成功");
      setMessage("验证码已发送，请查收邮箱");
      setCooldown(60);
    } catch (err) {
      notifyError(err, "验证码发送失败");
    } finally {
