...
// 像素艺术风格 SVG 图标库
// 全部使用 16x16 / 20x20 视图,使用纯色块,呈现像素艺术风格
...
/* ============== Logo ============== */
export const ToAiAPILogo = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const IconChartBar = ({ size = 20, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconChartLine = ({ size = 20, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconUserList = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
    <rect x="6" y="4" width="6" height="2" fill="currentColor" />
    <rect x="4" y="6" width="2" height="2" fill="currentColor" />
    <rect x="12" y="6" width="2" height="2" fill="currentColor" />
...
export const IconUserGroup = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconOrders = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconRecharge = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconBill = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconInvoice = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconModel = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconChannel = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconPrice = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconSystem = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
    <circle cx="12" cy="12" r="3" fill="currentColor" />
...
export const IconLog = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
    <rect x="4" y="3" width="16" height="18" fill="currentColor" />
...
export const IconBolt = ({ size = 24, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconQuote = ({ size = 18, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
export const IconLogoSmall = ({ size = 14, className }: IconProps) => (
  <svg {...baseProps(size, className)}>
...
/* ============== 模型 Logo (像素) ============== */
export const LogoOpenAI = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const LogoAnthropic = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const LogoGoogle = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const LogoMeta = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const LogoMixtral = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
export const LogoCohere = ({ size = 32 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" style={{ shapeRendering: "crispEdges" }}>
...
/* ============== 等距 3D 模型 logo ============== */
export const Isometric3DChart = () => (
  <svg width="500" height="380" viewBox="0 0 500 380" style={{ shapeRendering: "crispEdges" }}>
    {/* 中心立方体 */}
