...
import { ToAiAPILogo, IconChevronDown, QRCode, } from "@/components/PixelIcons";
export function Header() {
    return (<header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
    ...
    return (<footer className="bg-gray-50 border-t border-gray-100">
      <div className="max-w-[1280px] mx-auto px-6 py-12">
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[12.5px] text-gray-500">© 2024 ToAiAPI. All rights reserved.</p>
...
//# sourceMappingURL=SiteShell.js.map