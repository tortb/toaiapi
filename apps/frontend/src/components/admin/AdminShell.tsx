...
import { Bot, Building2, Cable, ClipboardList, FileText, Key, LayoutDashboard, LogOut, Mail, MessageSquare, PartyPopper, Receipt, Settings, Shield, Users, UsersRound } from "lucide-react";
...
const groups: [string, [typeof LayoutDashboard, string, string][]][] = [
  ...
  ["系统", [[Settings, "系统设置", "/admin/settings"], [Shield, "验证码", "/admin/captcha"], [Mail, "邮件", "/admin/settings/email"], [MessageSquare, "短信", "/admin/sms"]]],
];
