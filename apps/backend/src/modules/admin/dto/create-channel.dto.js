...
let CreateChannelDto = (() => {
    ...
    return class CreateChannelDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _providerId_decorators = [ApiProperty({ description: '所属 Provider ID' }), IsString()];
            _name_decorators = [ApiProperty({ description: '渠道名称', example: 'DeepSeek Main' }), IsString(), MaxLength(100)];
            _baseUrl_decorators = [ApiProperty({ description: 'API 基础 URL', example: 'https://api.deepseek.com' }), IsUrl()];
            _apiKey_decorators = [ApiProperty({ description: '上游 API Key' }), IsString()];
            _weight_decorators = [ApiPropertyOptional({ description: '权重（1-100）', example: 1, minimum: 1, maximum: 100 }), IsOptional(), IsInt(), Min(1), Max(100)];
            _priority_decorators = [ApiPropertyOptional({ description: '优先级（越高越优先）', example: 0 }), IsOptional(), IsInt(), Min(0), Max(100)];
        ...
        providerId = __runInitializers(this, _providerId_initializers, void 0);
        name = (__runInitializers(this, _providerId_extraInitializers), __runInitializers(this, _name_initializers, void 0));
