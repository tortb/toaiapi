...
let UpdateModelDto = (() => {
    ...
    return class UpdateModelDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _displayName_decorators = [ApiPropertyOptional({ description: '显示名称', example: 'DeepSeek Chat' }), IsOptional(), IsString(), MaxLength(200)];
            _maxContext_decorators = [ApiPropertyOptional({ description: '最大上下文长度', example: 128000 }), IsOptional(), IsInt(), Min(1)];
            _supportsStreaming_decorators = [ApiPropertyOptional({ description: '是否支持流式输出' }), IsOptional(), IsBoolean()];
            _supportsTools_decorators = [ApiPropertyOptional({ description: '是否支持工具调用' }), IsOptional(), IsBoolean()];
            _supportsVision_decorators = [ApiPropertyOptional({ description: '是否支持视觉' }), IsOptional(), IsBoolean()];
        ...
        maxContext = (__runInitializers(this, _displayName_extraInitializers), __runInitializers(this, _maxContext_initializers, void 0));
