...
let UpdateProviderDto = (() => {
    ...
    return class UpdateProviderDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _displayName_decorators = [ApiPropertyOptional({ description: '显示名称', example: 'DeepSeek' }), IsOptional(), IsString(), MaxLength(100)];
            _baseUrl_decorators = [ApiPropertyOptional({ description: 'API 基础 URL', example: 'https://api.deepseek.com' }), IsOptional(), IsUrl()];
            _isActive_decorators = [ApiPropertyOptional({ description: '是否启用' }), IsOptional()];
